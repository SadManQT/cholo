...
test('country boundary accepts representative Bangladesh locations', () => {
  assert.equal(isPointInsideBangladesh({ lat: 23.8103, lng: 90.4125 }), true);
  assert.equal(isPointInsideBangladesh({ lat: 24.8949, lng: 91.8687 }), true);
  assert.equal(isPointInsideBangladesh({ lat: 26.4880, lng: 88.3400 }), true);
});

test('country boundary rejects India points that still sit inside the old rectangle', () => {
  assert.equal(isPointInsideBangladesh({ lat: 22.5726, lng: 88.3639 }), false);
  assert.equal(isPointInsideBangladesh({ lat: 23.8315, lng: 91.2868 }), false);
});
