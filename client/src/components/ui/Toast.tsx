...
export function Toaster() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-20 z-[60] sm:bottom-4 flex flex-col items-center gap-2 px-4 sm:left-auto sm:right-4 sm:items-end">
      <AnimatePresence>
        {items.map((item) => (
